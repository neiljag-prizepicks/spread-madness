...
/** Group/shared password — not a login field; pairs with autocomplete="off" on the form. */
export function PasswordFieldWithToggle({
  ...
  return (
    <div className="group-hub-password-field">
      <input
      ...
      <button
        type="button"
        className="btn-ghost group-hub-password-toggle"
